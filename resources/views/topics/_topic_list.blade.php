            ...
            <li class="media">
                <div class="media-left">
                    <a href="{{ route('users.show', [$topic->user_id]) }}">
                        <img class="media-object img-thumbnail mr-3" style="width: 60px; height: 60px;" src="{{ $topic->user->avatar }}" title="{{ $topic->user->name }}">
                    </a>
                </div>

                <div class="media-body">

                    <div class="media-heading mt-0 mb-1" style="font-size: 18px;">
                        <a class="md-vi " href="{{ route('topics.show', [$topic->id]) }}" title="{{ $topic->title  }}">
                            {{ sbr_conten($topic->title) }}
                        </a>
